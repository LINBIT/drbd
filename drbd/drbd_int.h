...
extern int drbd_send_state_(struct drbd_device *mdev,
               union drbd_state s,
               const char *func, unsigned int line);
extern int drbd_send_current_state_(struct drbd_device *mdev,
               const char *func, unsigned int line);
...
static inline void drbd_kick_lo(struct drbd_device *mdev)
{
	if (get_ldev(mdev)) {
